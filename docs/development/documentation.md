...
gallery are generated by `python scripts/build_icon_catalog.py` from the icon
registry and the plugin source. The [icon style guide](icon-style-guide.md) is
maintained by hand so drawing instructions survive catalogue regeneration.
