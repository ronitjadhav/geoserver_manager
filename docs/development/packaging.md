...
CI rejects plugin archives of 1 MB or larger. If the archive grows unexpectedly,
check whether the bundled wheel was replaced with the upstream one. The shipped copy
